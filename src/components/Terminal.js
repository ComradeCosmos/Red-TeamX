...
export default function Terminal() {
  ...
  return (
    <div className="terminal-window fade-in-up-delay">
      <div className="terminal-header" onClick={() => inputRef.current?.focus()}>
        ...
        <div className="t-title" style={{ fontFamily: 'var(--font-pixel)', letterSpacing: '0.05em' }}>
          guest@redteamX:<span style={{ color: '#4b83fb' }}>~</span>
        </div>
      </div>
      <div className="terminal-body" ref={bodyRef} onClick={() => inputRef.current?.focus()} style={{ background: '#0a0a0a', padding: '1.5rem', fontFamily: 'var(--font-pixel)', fontSize: '1.1rem' }}>
